...
import cn.luozc.assemble_web.bean.sys.SysRoleMenu;
import cn.luozc.assemble_web.dao.sys.SysMenuDao;
...
public class MenuService {
    ...
    public JsonData getList(String rids){
        ...
        for (int i = 0; i < SysMenus.size(); i++) {
            ...
            if("0".equals(menu.getParentId())){
                ...
                List<JSONObject> sysMenus = menuTree(SysMenus,id);
                if(sysMenus.size()>0){
